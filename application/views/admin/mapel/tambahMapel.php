<div id="layoutSidenav_content">
	<main>
		<div class="container mb-4 mt-4">
			<center><h1> Form Tambah Mapel </h1></center>
				<form method="post" action="<?= base_url('C_Admin/aksiTambahMapel') ?>">
					<div class="form-group">
					    <label for="exampleInputEmail1">Nama Mapel</label>
					    <input type="text" name="nama" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan Nama Mapel">
					 </div>
					<div class="form-group">
